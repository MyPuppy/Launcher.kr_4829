    ...
    public static class GameSupport
    {
        ...
        public static void PrQuestUX2ndPacket()
        {
            ...
            using (OutPacket outPacket = new OutPacket("PrQuestUX2ndPacket"))
            {
                ...
                //questGroupIndex='1'
                outPacket.WriteInt(101001501);
                outPacket.WriteInt(101001501);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(101001502);
                outPacket.WriteInt(101001502);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(101001503);
                outPacket.WriteInt(101001503);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                //questGroupIndex = '2'
                outPacket.WriteInt(201010001);
                outPacket.WriteInt(201010001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(201020001);
                outPacket.WriteInt(201020001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(201030001);
                outPacket.WriteInt(201030001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(201040001);
                outPacket.WriteInt(201040001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                //questGroupIndex='3'
                outPacket.WriteInt(301010001);
                outPacket.WriteInt(301010001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(301020001);
                outPacket.WriteInt(301020001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(301030001);
                outPacket.WriteInt(301030001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(301040001);
                outPacket.WriteInt(301040001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(301050001);
                outPacket.WriteInt(301050001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(301060001);
                outPacket.WriteInt(301060001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                RouterListener.MySession.Client.Send(outPacket);
            }
